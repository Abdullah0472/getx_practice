...
class CommentBox extends StatefulWidget {
  ...
  const CommentBox({Key? key, required this.image, required this.controller, required this.inputRadius, required this.onSend , required this.onImageRemoved }) : super(key: key);
